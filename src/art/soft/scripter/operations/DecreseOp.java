 ...
 */
public class DecreseOp extends Operation<Variable> implements VariableReturnOp {
    
    public final VariableReturnOp operand;
    
    public DecreseOp(VariableReturnOp operand) {
    ...
    public Variable exec(ScriptCore core) {
        ...
        throw new RuntimeException("try to decrese static value");
    }
}
